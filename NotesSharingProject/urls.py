...
from django.conf import settings                      # Import while upload a file
from django.conf.urls.static import static              # Import while upload a file
...
]+static(settings.MEDIA_URL, document_root = settings.MEDIA_ROOT)   #While uploading a file
